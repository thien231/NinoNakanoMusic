...
module.exports = {
  name: "statistic",
  description: "Xem thống kê bot của bạn.",
  options: [],
      ...
      col.on('end', async (button) => {
        link_button = new ActionRowBuilder().addComponents(
          new ButtonBuilder()
            ...
            .setCustomId("Refresh")
            .setDisabled(true))
        return interaction.editReply({ content: "**Thời gian của bạn đã kết thúc!**", components: [link_button] }).catch(err => { })
      })
    }).catch(err => { })
  },
};
